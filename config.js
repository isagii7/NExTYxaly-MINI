...
module.exports = {
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || '💕⃝🕊️ NEXTY 𝗠𝗗 𝗠𝗶𝗻𝗶 💕⃝🕊️',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || 'NEXTY-MINI',
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ NEXTY-MINI',
     ...
     * @type {string}
     */
    IMAGE_PATH: process.env.IMAGE_PATH || 'https://files.catbox.moe/c7n9p5.jpg',
     ...
     * @type {string}
     */
    REPO: process.env.REPO || 'https://github.com/isagi7/NExTY',
